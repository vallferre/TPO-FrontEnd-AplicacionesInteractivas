...
const Navigation = () => {
  ...
  const handleSearch = async () => {
    ...
    if (trimmed) {
      // Llamamos al backend vía thunk (sin unwrap)
      await dispatch(searchProducts(trimmed));

      // Navegamos manteniendo el query param para que ProductsNavbar/Explore lo usen
